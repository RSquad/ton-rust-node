...
// Constants
// ======================================================================
// Thread naming, metric cadences, candidate-request / standstill timing,
// and source-ban thresholds for the receiver.
...
// Receiver interface
// ======================================================================
// Public contract used by SessionProcessor and the overlay transport:
// the Receiver / ReceiverListener traits plus their pointer aliases.
...
// ======================================================================
// ReceiverImpl — shared state
// ======================================================================
// Single-threaded consensus receiver state. The sections below split its
// inherent impl by lifecycle layer; support types sit beside their owners.
...
pub(crate) struct ReceiverImpl {
    ...
    /// Temporary bad-signature peer bans (C++ parity:
...
// ======================================================================
// ReceiverImpl — construction & teardown
// ======================================================================
// Task-queue plumbing and shutdown. The constructor lives in
// ReceiverWrapper::create; only Drop and the queue accessor live here.
...
// ======================================================================
// ReceiverImpl — session lifecycle
// ======================================================================
// Overlay attach/detach and the start/stop transitions.
...
// ======================================================================
// ReceiverImpl — delayed actions & timeouts
// ======================================================================
// Scheduling of future work and the next-wakeup computation.
...
// ======================================================================
// ReceiverImpl — low-level inbound/outbound
// ======================================================================
// Overlay bridge, ingress callbacks, payload classification, and the
// outbound send primitives shared by the consensus pipelines.
...
// ======================================================================
// ReceiverImpl — votes, certificates & broadcasts
// ======================================================================
// Ingress bounds and slot maintenance, message processing, certificate
// emission / accepted bookkeeping, and bad-signature source bans.
...
impl ReceiverImpl {
    ...
    // ------------------------------------------------------------------
    // Ingress bounds & slot maintenance
    // ------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------
    // Certificate emission & accepted bookkeeping
    // ------------------------------------------------------------------
...
// ======================================================================
// ReceiverImpl — standstill
// ======================================================================
// Liveness fallback: scheduling, the bounded replay queue, egress shaping,
// and the vote/certificate replay caches.
...
// ======================================================================
// ReceiverImpl — candidate repair
// ======================================================================
// Client-side block-repair resolver: request issue, peer selection,
// response validation, serving, and the resolver cache.
...
// ======================================================================
// ReceiverImpl — diagnostics & telemetry
// ======================================================================
// Activity snapshots, debug dumps, and active-weight accounting.
...
// ======================================================================
// ReceiverWrapper — crate-internal interface & threads
// ======================================================================
// Thread-safe facade implementing the Receiver trait by posting closures
// to the receiver thread; owns settings, worker threads, and construction.
