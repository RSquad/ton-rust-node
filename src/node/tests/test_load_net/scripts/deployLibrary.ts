...
export async function run(provider: NetworkProvider) {
    ...
    const librarian = tonClient.open(Librarian.createFromConfig({ code: jettonWalletCodeRaw }, librarianCode));
    ...
    await librarian.sendDeploy(await faucetWallet.getSender(), tonAmount);
